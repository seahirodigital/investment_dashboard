...
SECTORS = {
  ...
  '1618.T': 'エネルギー資源',              # MT/PET 複合ETF（バスケットで分離）
  '1619.T': '建設・資材',                  # CON 単独
  ...
  '1613.T': '情報・通信業',               # TPXI
  '1615.T': '銀行業',                     # BNK 新コード
  '1311.T': 'TOPIX500バリュー',           # TPX500V
  '1312.T': 'TOPIX500グロース',           # TPX500G
  '1321.T': '日経225ETF',                 # NI225 ETF
  '^TNX':   '米国債10年',                  # 10501 米国債10年利回り(CBOE)
  '2644.T': '半導体ETF',                  # Global X 日本半導体ETF
  '200A.T': 'GX日本成長',                 # GX日本成長投資ETF
  '1310.T': 'TOPIX Core30',              # CORE30
  '1589.T': 'TOPIX Mid400',              # MID400
  '1020.T': 'TOPIX Large70',             # LARGE70 ※要確認
  '1022.T': 'TOPIX Small',               # SMALL  ※要確認
  '1023.T': 'TOPIX 100',                 # TPX100 ※要確認
  '1024.T': 'TOPIX 500',                 # TPX500 ※要確認
  '1025.T': 'TOPIX 1000',               # TPX1000 ※要確認
}
