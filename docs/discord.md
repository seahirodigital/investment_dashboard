...
|---|---|---:|---|---|---|---|---|
| 朝の市況Discord通知 | `C:\Users\mahha\OneDrive\開発\investment_dashboard\.github\workflows\morning_market_discord.yml` | 平日 07:00 JST（月〜金） / `0 22 * * 0-4` UTC | あり | 常に送信 | Fear & Greed Indexの数値とURL、日経VIXの数値とURL、FinvizヒートマップURL、指定ハッシュタグ | 1. Finvizヒートマップ<br>2. Fear & Greed Index<br>3. 日経VIX 1wチャート | 成功。直近手動実行: 2026-05-20 23:54 JST / `https://github.com/seahirodigital/investment_dashboard/actions/runs/26170687841` |
