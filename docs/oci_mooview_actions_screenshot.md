...
| **平日 11:35（一時停止中）** | [Sector Category Discord Screenshots](file:///c:/Users/mahha/OneDrive/開発/investment_dashboard/.github/workflows/sector_category_discord.yml)<br>`sector_category_discord.yml` | **【Actions定期実行は一時停止】** 日本株の前場通知。Oracle版とActionsの手動実行は継続 |
| **平日 15:45（一時停止中）** | [Sector Category Discord Screenshots](file:///c:/Users/mahha/OneDrive/開発/investment_dashboard/.github/workflows/sector_category_discord.yml)<br>`sector_category_discord.yml` | **【Actions定期実行は一時停止】** 日本株の大引け通知。Oracle版とActionsの手動実行は継続 |
